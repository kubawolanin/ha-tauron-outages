...
from custom_components.tauron_outages.api import (
    ApiClientException,
    TauronOutagesApiClient,
)
...
async def test_api(hass, aioclient_mock):
    ...
    api = TauronOutagesApiClient("test", "test", async_get_clientsession(hass))
